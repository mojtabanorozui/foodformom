...
/** Hand-crafted recipes for iconic dishes */
const recipeOverrides: Record<string, Recipe> = {
  "1": {
    stepsEn: [
    ...
    stepsFa: [
      ...
      "لوبia قرمز خیس‌خورده و آب کافی اضافه کنید. ۱ ساعت بپزید.",
...
export function getRecipe(food: Food): Recipe {
  return recipeOverrides[food.id] ?? generateRecipe(food);
}
